...
```sh
curl -LO https://github.com/davefx/clipboardwire/releases/latest/download/clipboardwire_0.4.3-1_amd64.deb
sudo apt install ./clipboardwire_0.4.3-1_amd64.deb
...
```sh
curl -LO https://github.com/davefx/clipboardwire/releases/latest/download/clipboardwire-0.4.3-1.x86_64.rpm
sudo dnf install ./clipboardwire-0.4.3-1.x86_64.rpm
```

### Windows

Download `clipboardwire-0.4.3-x86_64.msi` from the
...
Currently shipping: **v0.4.3** — see [CHANGELOG.md](CHANGELOG.md).
